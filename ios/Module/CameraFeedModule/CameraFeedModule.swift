...
import AVFoundation
  ...
  // MARK: CameraFeedModuleDelegate Declaration
protocol CameraFeedModuleDelegate: AnyObject {
 ...
 */
class CameraFeedModule: NSObject {
  /**
  ...
  private let sessionQueue = DispatchQueue(label: "com.google.mediapipe.CameraFeedModule.sessionQueue")
  ...
  weak var delegate: CameraFeedModuleDelegate?
  ...
  private func addObservers() {
    NotificationCenter.default.addObserver(self, selector: #selector(CameraFeedModule.sessionRuntimeErrorOccured(notification:)), name: NSNotification.Name.AVCaptureSessionRuntimeError, object: session)
    NotificationCenter.default.addObserver(self, selector: #selector(CameraFeedModule.sessionWasInterrupted(notification:)), name: NSNotification.Name.AVCaptureSessionWasInterrupted, object: session)
    NotificationCenter.default.addObserver(self, selector: #selector(CameraFeedModule.sessionInterruptionEnded), name: NSNotification.Name.AVCaptureSessionInterruptionEnded, object: session)
  }
 ...
 */
extension CameraFeedModule: AVCaptureVideoDataOutputSampleBufferDelegate {
